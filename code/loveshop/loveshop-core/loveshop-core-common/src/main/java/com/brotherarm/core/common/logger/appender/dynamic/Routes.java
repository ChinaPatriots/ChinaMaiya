 ...
 */
//@Plugin(name = "DRoutes", type = "Core", printObject = true)
@Plugin(name = "DRoutes", category = "Core", printObject = true)
public final class Routes {
     ...
     */
    @PluginFactory
    public static Routes createRoutes(@PluginAttribute("pattern") final String pattern,
